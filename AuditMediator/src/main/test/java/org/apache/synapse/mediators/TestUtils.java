...
public class TestUtils {
	...
	public static MessageContext getTestContext(String bodyText,
	...
	public static MessageContext createLightweightSynapseMessageContext(
		...
		return createLightweightSynapseMessageContext(payload,
	...
	public static MessageContext createSynapseMessageContext(String payload,
	...
	public static void addSOAPHeaderBlock(
			org.apache.axis2.context.MessageContext msgCtx, QName qname,
			String value) {
		...
		SOAPHeaderBlock header = env.getHeader().addHeaderBlock(
				...
				msgCtx.getEnvelope()
						.getOMFactory()
						.createOMNamespace(qname.getNamespaceURI(),
								qname.getPrefix()));
