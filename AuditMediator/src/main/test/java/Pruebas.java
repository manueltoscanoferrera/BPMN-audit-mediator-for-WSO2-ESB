...
public class Pruebas {
	...
	public static void main(String args[]) {
		...
		try {
			...
			BusinessProcessAudit businesCloneLow = AuditMediatorUtils.getBusinessProcessWithDetailLevel(busines, "low");
			
			
			BusinessProcessAudit businesCloneMedium = AuditMediatorUtils.getBusinessProcessWithDetailLevel(busines, "medium");
			
			
			BusinessProcessAudit businesCloneHigh = AuditMediatorUtils.getBusinessProcessWithDetailLevel(busines, "high");
